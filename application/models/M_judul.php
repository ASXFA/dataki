...
class M_judul extends CI_Model
{
    ...
    function get_count()
    {
        $this->db->select(" TAHUN_DATA, COUNT(IF(BIDANG_DATA='WEBSITE',1,NULL)) 'Website', 
        COUNT(IF(BIDANG_DATA='ANDROID',1,NULL)) 'Android', COUNT(IF(BIDANG_DATA='JARINGAN',1,NULL)) 
        'Jaringan',COUNT(IF(BIDANG_DATA='SECURITY',1,NULL)) 'Security'");
