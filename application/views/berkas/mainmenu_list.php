                ...
                <!-- <div class="col-md-12"> -->
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <center><h3 class="box-title">DATA KARYA ILMIAH INFORMATIKA UNLA</h3></center>
                        </div><!-- /.box-header -->
                        <!-- form start -->
                        <div class="box-body">
                            <div class="row">
                            ...
                            ?>
                                ...
                                <hr>
                                    <div class="card">
                                        <h4><b><?php echo nl2br(str_replace($h['KATA'],"<font color='red'><b>".ucfirst($h['KATA'])."</b></font>",strtolower($h['JUDUL_DATA']))) ?></b></h4>
                                        <h4><?php echo $h['ABSTRAK_DATA']; ?></h4>
                                        <table class="table">
                                            <tr>
                                                <td width="6%"><?= $h['NAME'] ?></td>
                                                <td width="1%"> | </td>
                                                <td width="7%"><?= $h['NO_USER'] ?></td>
                                                <td width="1%"> | </td>
                                                <td width="5%"><?= $h['BIDANG_DATA'] ?></td>
                                                <td width="1%">|</td>
                                                <td width="3%"><?= $h['TAHUN_DATA'] ?></td>
                                                <td width="1%">|</td>
                                                <!-- <td width="7%"><a href="<?php echo base_url(); ?>index.php/upload/download/<?php echo $h['ID_DATA'];; ?>"><i class="fa fa-download"></i> Download</a></td> -->
                                                <td></td>
                                            </tr>
                                        </table>
