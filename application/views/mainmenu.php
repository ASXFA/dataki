  ...
  <div class="content-wrapper">
    <div class="container">
      ...
      <section class="content-header">
        <h4><center><strong>
          Selamat Datang di Website Data Karya Ilmiah Teknik Informatika Universitas Langlangbuana</strong>
      ...
      <section class="content">
        <div class="callout callout-info">
          ...
          <p>Website ini digunakan untuk mengelola data karya ilmiah yang terdapat di Program Studi Teknik Informatika Universitas Langlangbuana</p>
        </div><br>
        <div class="callout callout-danger">
          <h4>T&C</h4>

          <p>Webiste ini dapat digunakan oleh Dosen dan Mahasiswa Program Studi Teknik Informatika Universitas Langlangbuana dan Admin sebagai pengelola data karya ilmiah</p>
        </div><br>
